...
export default function ContestRulesPage() {
  ...
  return (
    <div className="bg-gradient-to-br from-gray-50 to-blue-100 flex min-h-screen flex-col p-20">
      ...
      {DsaContestDetails.map((detail, index) => (
        <div className="bg-blue-50 p-8 my-4 rounded-lg border-l-4 border-blue-300">
      ...
      <br/>
      <br/>
      <Link className="bg-blue-500 w-48 rounded-lg py-2 px-4 text-white text-2xl" to="/code">Go to contest</Link><br/>
